...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    static let appDelegate: AppDelegate = AppDelegate()
    ...
    func showAlertWithOkButton(strMessage:String) -> Void {
        ...
        DispatchQueue.main.async {
            ...
            topController.present(alert, animated: true, completion: { _ in })
        }
    }
